...
class CaptureStrategyCommand implements CommandInterface
{
     ...
     * @param OptimalAdapter $optimalAdapter
    ...
    public function __construct(
        ...
        $this->optimalAdapter = $optimalAdapter;
    ...
    {
        $collection = $this->optimalAdapter->search(
            [
