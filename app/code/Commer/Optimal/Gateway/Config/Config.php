...
use Commer\Optimal\Model\Adminhtml\Source\Environment;
...
class Config extends \Magento\Payment\Gateway\Config\Config
{
    ...
    public function getOrderRefNumber($orderNumber) {
        if($this->isLiveEnv()) {
            return "order-live-" . $orderNumber;
        }
        return "test-live-" . $orderNumber;
    }

    public function isLiveEnv() {
        return $this->getEnvironment() == Environment::ENVIRONMENT_PRODUCTION;
    }
