...
define([
    ...
    return Class.extend({
        ...
        defaults: {
            $selector: null,
            selector: 'edit_form',
            container: 'payment_form_optimal',
            active: false,
            scriptLoaded: false,
            optimal: null,
        ...
        onActiveChange: function (isActive) {
            return;
            if (!isActive) {
                this.$selector.off('submitOrder.optimal');
        ...
        loadScript: function () {
            ...
            require([this.sdkUrl], function (optimal) {
                state(true);
        ...
        initBraintree: function () {
            ...
            try {
                ...
                self.optimal.setup(self.clientToken, 'custom', {
                    id: self.selector,
        ...
        enableEventListeners: function () {
            this.$selector.on('submitOrder.optimal', this.submitOrder.bind(this));
        },
        ...
        validateCardType: function () {
            ...
            $input.removeClass('optimal-hosted-fields-invalid');

            if (!this.selectedCardType()) {
                $input.addClass('optimal-hosted-fields-invalid');
