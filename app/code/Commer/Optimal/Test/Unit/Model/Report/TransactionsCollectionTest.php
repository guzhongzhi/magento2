...
use Commer\Optimal\Model\Report\TransactionsCollection;
 ...
 *
 * Test for class \Commer\Optimal\Model\Report\TransactionsCollection
 */
class TransactionsCollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->braintreeAdapterMock = $this->getMockBuilder(OptimalAdapter::class)
            ->setMethods(['search'])
            ->disableOriginalConstructor()
            ->getMock();
    }
