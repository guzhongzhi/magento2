 ...
 */
namespace Commer\Optimal\Test\Unit\Gateway\Command;

use Braintree\IsNode;
use Braintree\MultipleValueNode;
use Braintree\TextNode;
use Commer\Optimal\Gateway\Command\CaptureStrategyCommand;
...
class CaptureStrategyCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->braintreeAdapter = $this->getMockBuilder(OptimalAdapter::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    /**
     * @covers \Commer\Optimal\Gateway\Command\CaptureStrategyCommand::execute
     */
