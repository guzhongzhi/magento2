...
class ConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @covers       \Commer\Optimal\Gateway\Config\Config::getCountryAvailableCardTypes
     * @dataProvider getCountrySpecificCardTypeConfigDataProvider
    ...
    /**
     * @covers \Commer\Optimal\Gateway\Config\Config::isCvvEnabled
     */
     ...
     * @covers \Commer\Optimal\Gateway\Config\Config::isVerify3DSecure
     */
     ...
     * @covers \Commer\Optimal\Gateway\Config\Config::getThresholdAmount
     ...
     * @param int $value
     * @param array $expected
     * @covers \Commer\Optimal\Gateway\Config\Config::get3DSecureSpecificCountries
    ...
    /**
     * @covers \Commer\Optimal\Gateway\Config\Config::getDynamicDescriptors
     * @param $name
     * @param $phone
     * @param $url
     * @param array $expected
