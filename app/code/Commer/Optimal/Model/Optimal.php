...
class Optimal extends \Magento\Payment\Model\Method\Cc
{
    ...
    public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
         ...
         */
        $transRepository = $objectManager->get("Magento\Sales\Model\Order\Payment\Transaction\Repository");
        $transManager = $objectManager->get("Magento\Sales\Model\Order\Payment\Transaction\Manager");
