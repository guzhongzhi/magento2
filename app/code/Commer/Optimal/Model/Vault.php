<?php
namespace Commer\Optimal\Model;
...
class Vault extends \Magento\Vault\Model\Method\Vault {
    ...
    private function attachTokenExtensionAttribute(OrderPaymentInterface $orderPayment)
    {
        ...
        $paymentInfo = self::$paymentInfo["payment_info"];
        $additionalInformation = array_merge($additionalInformation,$paymentInfo["additional_data"]);
    ...
    {
        self::$paymentInfo["payment_info"] = $data;
